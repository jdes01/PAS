...
int main(int argc, char **argv) {
    ...
    /* opterr=0; */
    while ( (c= getopt_long(argc, argv, "abxd:c:f:", long_options, NULL)) != -1) {
    ...
    printf("aflag = %d, bflag = %d, xflag = %d, cvalue = %s, dvalue = %s, fvalue = %s\n", aflag, bflag, xflag, cvalue, dvalue, fvalue);
