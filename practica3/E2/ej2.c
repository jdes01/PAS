...
// /etc/passwd fichero donde viene la informacion de los usuarios
// /etc/group  fichero donde viene la informacion de los grupos
...
int main(int argc, char *argv[]) {
    ...
    printf("ID del grupo principal: %u\n", gr->gr_gid);
